...
george.penup()
george.goto(-b, -corner3)
george.pendown()
drawRectangle(george, a, 110, "blue")

# Draw and fill the front door
george.penup()
george.goto(-corner3, -corner3)
george.pendown()
drawRectangle(george, 40, corner2, "lightgreen")

# Front roof
george.penup()
george.goto(-b, -10)
george.pendown()
drawTriangle(george, a, "magenta")

# Side of the house
george.penup()
george.goto(-50, -corner3)
george.pendown()
drawParallelogram(george, corner2, 110, "yellow")

# Window
george.penup()
george.goto(-30, -corner2)
george.pendown()
...
george.begin_fill()
george.left(30)
george.forward(corner2)
george.left(105)
george.forward(a / math.sqrt(2))
george.left(75)
george.forward(corner2)
george.left(105)
george.forward(a / math.sqrt(2))
...
# Tree top
george.penup()
george.goto(65, -corner)
george.pendown()
drawTriangle(george, corner, "lightgreen")
george.penup()
george.goto(70, -45)
george.pendown()
